...
data class ColorTheme(
    ...
    val dialogItemColor: Int,
    val dialogShadow: Int,
...
object Theme {
    val themeColorsList: SnapshotStateList<ColorTheme> = mutableStateListOf(
        ...
        ColorTheme(
            ...
            dialogItemColor = R.color.grey_500,
            dialogShadow = R.color.white,
        ...
        ColorTheme(
            ...
            dropDownMenuBackground = R.color.grey_800,
            dialogTextColor = R.color.white,
            dialogTextHighlight = R.color.grey_700,
            dialogItemColor = R.color.grey_800,
            dialogShadow = R.color.black,
